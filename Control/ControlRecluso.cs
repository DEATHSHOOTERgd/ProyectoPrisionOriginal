...
namespace Control
{
    ...
    public class ControlRecluso
    {
        ...
        public bool ActualizarUsuario(string codigo, string nombre, string apellido, string genero, DateTime fecha, int idExpediente, string cedula)
        {
            Expediente exp = datosRecluso.BuscarExpediente(cedula);
            recluso = new Recluso(nombre, apellido, genero, fecha, cedula, codigo, exp);
            ...
            try
            {
                datosRecluso.ActualizarRecluso(recluso);
                return true;
            }
